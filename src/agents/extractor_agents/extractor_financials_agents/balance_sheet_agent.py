...
def run_balance_sheet_agent(
    ...
    initial_prompt = (
        ...
        f"(hint: try searching for keywords like 'cash', 'receivable', or 'payable'), "
    ...
    def append_markdown(text: str) -> str:
        """Append a markdown text segment or table to the balance sheet output file."""
    ...
    def check_balance_sheet_quality() -> str:
        """Run a quality check on the currently extracted balance sheet to verify mathematical consistency and formatting."""
    ...
    def finalize(currency: str, unit: str) -> str:
        """Finalize the balance sheet extraction, specifying the detected currency (e.g. 'USD', 'CNY') and unit (e.g. 'Millions')."""
